...
public class DistrictDetailsActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = findViewById(R.id.schedule_supply);
        Intent intent = getIntent();
        Bundle bundle = intent.getExtras();
        district = bundle.getString("district");
        final RequestQueue queue = Volley.newRequestQueue(DistrictDetailsActivity.this);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for(int i=0;i<jsonArray.length();i++)
                            {
                                ...
                                CustomString obj = new CustomString(name,address,phone,water_clean,water_normal);
                                list.add(obj);
                            }
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent1 = new Intent(DistrictDetailsActivity.this,MapsMarkerActivity.class);
